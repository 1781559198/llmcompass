...
class SiLU(Operator):
    ...
    def compile_and_simulate(self, pcb_module: Device, compile_mode=None):
        ...
        is_l2_double_buffering = False  # SiLU may not benefit much from double buffering
    ...
    class L1TileSimulator:
        def __init__(
            ...
            self.reduction_cycle_count = (
                0  # SiLU typically doesn't require reduction steps
            )
        ...
        def simulate_l1_tile_compute_cycle_count(
            ...
            # Compute sigmoid(x) and multiply by x for SiLU
            total_flop_count = M * N * (self.flops_per_exp + 2 + 1)  # add + division + multiply
            return ceil(
                total_flop_count
